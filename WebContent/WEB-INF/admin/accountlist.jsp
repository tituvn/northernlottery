								...
								<c:forEach items="${accountList}" var="acc">
									<div class="text-truncate">
										<tr>
											...
											<td class=""><c:set var="onl" value="${acc.getOnline()}" />
												<c:choose>
							...
							<nav class="mt-4" aria-label="">
								<ul class="pagination justify-content-center">
									<li class="page-item" id="previousPage"><a
										class="page-link"
										href="accounts?action=pagination&index=${index-1}"
									...
									<li class="page-item" id="nextPage"><a class="page-link"
										href="accounts?action=pagination&index=${index+1}">Sau</a></li>
								</ul>
							</nav>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						Bạn thật sự muốn xóa id = <span id="idToDelete"></span> ? <input
							type="hidden" id="deleteDelete" value="" />
					</div>
					<div class="row modal-footer">
						<button type="button" class="btn btn-primary"
							onclick="deleteItem()" style="width: 25%">Đồng ý</button>
						<button type="button" class="btn btn-info" data-dismiss="modal"

				...
				<div>
					<form class="" action="accounts" method="POST">
						<input type="hidden" name="action" value="updateRole" /> <input
							type="hidden" name="account_id" value="${acc.getAccount_id()}" />
						<div>
							<div class="form-group row">
								...
								<div class="col-9">
									<input class="form-control" type="text"
										value="${acc.getUsername()}" name="username" readonly />
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-9">
									<input class="form-control" type="text"
										value="${acc.getFullName()}" name="fullName" readonly />
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-9">
									<input class="form-control" type="text"
										value="${acc.getEmail()}" name="email" readonly />
								</div>
							</div>
							<div class="form-group row">
								...
								<div class="col-9">
									<input class="form-control" type="text"
										value="${acc.getPhone()}" name="phone" readonly />
								</div>
							</div>
...
<!-- Phan script va cac thanh phan khong hien thi -->
